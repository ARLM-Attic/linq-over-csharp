...
namespace CSharpFactory.ParserFiles.PPExpressions {
    ...
    Token NextToken()
    {
      ...
      switch (state)
      {
        ...
        case 0: { t.kind = noSym; break; }   // NextCh already done
			case 1:
				if (ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z' || ch == 170 || ch == 181 || ch == 186 || ch >= 192 && ch <= 214 || ch >= 216 && ch <= 246 || ch >= 248 && ch <= 255) {AddCh(); goto case 2;}
				else if (ch == 92) {AddCh(); goto case 16;}
				else {t.kind = noSym; break;}
			case 2:
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z' || ch == 160 || ch == 170 || ch == 181 || ch == 186 || ch >= 192 && ch <= 214 || ch >= 216 && ch <= 246 || ch >= 248 && ch <= 255) {AddCh(); goto case 2;}
				else if (ch == 92) {AddCh(); goto case 3;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 3:
				if (ch == 'u') {AddCh(); goto case 4;}
				else if (ch == 'U') {AddCh(); goto case 8;}
				else {t.kind = noSym; break;}
			case 4:
