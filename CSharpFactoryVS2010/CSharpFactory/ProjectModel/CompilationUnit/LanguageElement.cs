...
namespace CSharpFactory.ProjectModel
{
  ...
  public abstract class LanguageElement
  {
    ...
    // --------------------------------------------------------------------------------
    protected LanguageElement(ParserFiles.Token token, LanguageElement contextElement)
    ...
    // --------------------------------------------------------------------------------
    protected LanguageElement(ParserFiles.Token token, CSharpSyntaxParser parser)
    {
      _Token = token;
    ...
    // --------------------------------------------------------------------------------
    protected LanguageElement(ParserFiles.Token token, CSharpSyntaxParser parser, string name):
      this(token, parser)
    {
      _Name = name;
    }
    ...
    /// </summary>
    // --------------------------------------------------------------------------------
    public ParserFiles.Token Token
    {
      get { return _Token; }
    }
    ...
    /// </summary>
    // --------------------------------------------------------------------------------
    public ParserFiles.Token TerminatingToken
    {
