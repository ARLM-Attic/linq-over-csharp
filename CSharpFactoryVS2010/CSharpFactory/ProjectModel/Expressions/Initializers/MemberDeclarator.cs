...
namespace CSharpFactory.ProjectModel
{
  ...
  public class MemberDeclarator : ExpressionInitializer
  {
    ...
    // --------------------------------------------------------------------------------
    public MemberDeclarator(ParserFiles.Token token, CSharpSyntaxParser parser, string identifier) : 
    ...
    /// <param name="identifier">Identifier belonging to the member</param>
    // --------------------------------------------------------------------------------
    public MemberDeclarator(ParserFiles.Token token, CSharpSyntaxParser parser, Expression expr, 
      string identifier) :
