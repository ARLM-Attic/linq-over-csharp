...
namespace CSharpFactory.ProjectModel
{
  ...
  public sealed class AndOperator : BinaryOperator
  {
    ...
    // --------------------------------------------------------------------------------
    public AndOperator(ParserFiles.Token token, CSharpSyntaxParser parser) : base(token, parser)
    {
    }
    ...
    // --------------------------------------------------------------------------------
    public AndOperator(ParserFiles.Token token, Expression leftOperand) : 
