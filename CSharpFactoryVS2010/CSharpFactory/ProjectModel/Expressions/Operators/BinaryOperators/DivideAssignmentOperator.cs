...
namespace CSharpFactory.ProjectModel
{
  ...
  /// </summary>
  // ==================================================================================
  public sealed class DivideAssignmentOperator : AssignmentOperator
  {
    // --------------------------------------------------------------------------------
    /// <summary>
    ...
    // --------------------------------------------------------------------------------
    public DivideAssignmentOperator(ParserFiles.Token token, CSharpSyntaxParser parser) : base(token, parser)
    {
    }
    ...
    // --------------------------------------------------------------------------------
    public DivideAssignmentOperator(ParserFiles.Token token, Expression leftOperand) : 
    ...
    // --------------------------------------------------------------------------------
    public DivideAssignmentOperator(Token token, Expression leftOperand, Expression rightOperand)
