...
namespace CSharpFactory.ProjectModel
{
  ...
  public sealed class GreaterThanOperator : BinaryOperator
  {
    ...
    // --------------------------------------------------------------------------------
    public GreaterThanOperator(ParserFiles.Token token, CSharpSyntaxParser parser) : base(token, parser)
    {
    }
    ...
    // --------------------------------------------------------------------------------
    public GreaterThanOperator(ParserFiles.Token token, Expression leftOperand) : 
