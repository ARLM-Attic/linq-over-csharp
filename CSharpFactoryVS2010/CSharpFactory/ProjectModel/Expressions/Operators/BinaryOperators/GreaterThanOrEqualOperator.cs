...
namespace CSharpFactory.ProjectModel
{
  ...
  public sealed class GreaterThanOrEqualOperator : BinaryOperator
  {
    ...
    // --------------------------------------------------------------------------------
    public GreaterThanOrEqualOperator(ParserFiles.Token token, CSharpSyntaxParser parser) : base(token, parser)
    {
    } 
    ...
    // --------------------------------------------------------------------------------
    public GreaterThanOrEqualOperator(ParserFiles.Token token, Expression leftOperand) : 
