...
namespace CSharpFactory.ProjectModel
{
  ...
  public sealed class MemberAccessOperator : BinaryOperator
  {
    ...
    // --------------------------------------------------------------------------------
    public MemberAccessOperator(ParserFiles.Token token, CSharpSyntaxParser parser) : base(token, parser)
    {
    }
    ...
    // --------------------------------------------------------------------------------
    public MemberAccessOperator(ParserFiles.Token token, Expression leftOperand) : 
    ...
    // --------------------------------------------------------------------------------
    public MemberAccessOperator(Token token, Expression leftOperand, Expression rightOperand)
