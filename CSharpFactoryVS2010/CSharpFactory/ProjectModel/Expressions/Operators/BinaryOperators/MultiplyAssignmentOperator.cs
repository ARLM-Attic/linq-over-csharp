...
namespace CSharpFactory.ProjectModel
{
  ...
  public sealed class MultiplyAssignmentOperator : AssignmentOperator
  {
    ...
    // --------------------------------------------------------------------------------
    public MultiplyAssignmentOperator(ParserFiles.Token token, CSharpSyntaxParser parser) : base(token, parser)
    {
    }
    ...
    // --------------------------------------------------------------------------------
    public MultiplyAssignmentOperator(ParserFiles.Token token, Expression leftOperand) : 
