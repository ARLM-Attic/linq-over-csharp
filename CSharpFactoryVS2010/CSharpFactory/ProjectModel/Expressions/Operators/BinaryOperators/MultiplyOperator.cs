...
namespace CSharpFactory.ProjectModel
{
  ...
  public sealed class MultiplyOperator : BinaryOperator
  {
    ...
    // --------------------------------------------------------------------------------
    public MultiplyOperator(ParserFiles.Token token, CSharpSyntaxParser parser) : base(token, parser)
    {
    }
    ...
    // --------------------------------------------------------------------------------
    public MultiplyOperator(ParserFiles.Token token, Expression leftOperand) : 
