...
namespace CSharpFactory.ProjectModel
{
  ...
  public sealed class NotEqualOperator : BinaryOperator
  {
    ...
    // --------------------------------------------------------------------------------
    public NotEqualOperator(ParserFiles.Token token, CSharpSyntaxParser parser) : base(token, parser)
    {
    }
    ...
    // --------------------------------------------------------------------------------
    public NotEqualOperator(ParserFiles.Token token, Expression leftOperand) : 
    ...
    // --------------------------------------------------------------------------------
    public NotEqualOperator(Token token, Expression leftOperand, Expression rightOperand)
