...
namespace CSharpFactory.ProjectModel
{
  ...
  public sealed class SubtractOperator : BinaryOperator
  {
    ...
    // --------------------------------------------------------------------------------
    public SubtractOperator(ParserFiles.Token token, CSharpSyntaxParser parser) : base(token, parser)
    {
    }
    ...
    // --------------------------------------------------------------------------------
    public SubtractOperator(ParserFiles.Token token, Expression leftOperand) : 
