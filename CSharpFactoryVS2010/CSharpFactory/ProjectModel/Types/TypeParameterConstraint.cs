...
namespace CSharpFactory.ProjectModel
{
  ...
  public sealed class ConstraintElement : LanguageElement
  {
    ...
    // --------------------------------------------------------------------------------
    public ConstraintElement(ParserFiles.Token token, CSharpSyntaxParser parser, 
    ...
    // --------------------------------------------------------------------------------
    public ConstraintElement(ParserFiles.Token token, CSharpSyntaxParser parser, TypeReference type)
      : base(token, parser)
    {
