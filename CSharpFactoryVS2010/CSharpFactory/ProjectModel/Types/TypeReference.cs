...
namespace CSharpFactory.ProjectModel
{
    ...
    ITypeAbstraction
  {
    ...
    /// </remarks>
    // --------------------------------------------------------------------------------
    public TypeReference(ParserFiles.Token token, CSharpSyntaxParser parser) : base(token, parser)
    {
      Name = token.val;
  ...
  /// </summary>
  // ==================================================================================
  public sealed class TypeReferenceCollection : ImmutableCollection<TypeReference>
  { }
