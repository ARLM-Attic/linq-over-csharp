...
namespace CSharpFactory.Collections
{
  ...
  /// </remarks>
  // ==================================================================================
  public class ImmutableCollection<T> : IList<T>, IReadOnlySupport
  {
    ...
    public void Add(T item)
    {
      if (_BeforeAdd != null)
      {
        var eventArgs = new ItemedCancelEventArgs<T>(item);
    ...
    {
      if (IsReadOnly) throw new ImmutableChangedException();
    }
