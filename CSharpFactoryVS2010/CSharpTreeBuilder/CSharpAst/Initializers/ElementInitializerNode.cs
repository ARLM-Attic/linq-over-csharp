...
namespace CSharpTreeBuilder.Ast
{
  ...
  public class ElementInitializerNode : SyntaxNode<ISyntaxNode>
  {
    ...
    public override void AcceptVisitor(ISyntaxNodeVisitor visitor)
    {
      ...
      if (NonAssignmentExpression!=null)
      {
        NonAssignmentExpression.AcceptVisitor(visitor);
      }

      foreach (var expressionList in ExpressionList)
      {
        expressionList.AcceptVisitor(visitor);
      }
    }
