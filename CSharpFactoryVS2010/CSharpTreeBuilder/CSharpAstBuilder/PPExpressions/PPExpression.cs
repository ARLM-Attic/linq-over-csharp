...
namespace CSharpTreeBuilder.CSharpAstBuilder.PPExpressions
{
  ...
  public abstract class PPExpression
  {
    ...
    public PPExpression LeftmostExpression
    {
      get
      {
        var unOp = this as PPUnaryOperator;
        if (unOp != null) return unOp.Operand.LeftmostExpression;
        var binOp = this as PPBinaryOperator;
        return binOp != null ? binOp.LeftOperand.LeftmostExpression : this;
      }
    }
  }
  ...
  public abstract class PPBinaryOperator : PPExpression
  {
    ...
    /// </summary>
// --------------------------------------------------------------------------------
    public PPExpression LeftOperand { get; set; }
    ...
    /// </summary>
    // --------------------------------------------------------------------------------
    public PPExpression RightOperand { get; set; }
    ...
    public PPBinaryOperator LeftMostNonNull
    {
      get
      {
        ...
        do
        {
          ...
          var next = current.LeftOperand as PPBinaryOperator;
