...
namespace CSharpTreeBuilder.CSharpSemanticGraphBuilder
{
    ...
    where TTargetType: class
  {
    ...
    // ----------------------------------------------------------------------------------------------
    protected static NamespaceOrTypeEntity ResolveNamespaceOrTypeNode(
      ...
      ICompilationErrorHandler errorHandler)
    {
      ...
      if (namespaceOrTypeName.HasQualifier)
      {
        foundEntity = ResolveQualifiedAliasMember(
          ...
          resolutionContextEntity.SemanticGraph.GlobalNamespace, errorHandler);
    ...
    // ----------------------------------------------------------------------------------------------
    private static List<TypeEntity> ResolveTypeArguments(
    ...
    /// </returns>
    // ----------------------------------------------------------------------------------------------
    private static TypeEntity GetConstructedTypeEntity(TypeEntity typeEntity, List<TypeEntity> typeArguments)
    {
