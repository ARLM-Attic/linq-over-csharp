...
namespace CSharpTreeBuilder.CSharpSemanticGraphBuilder
{
  ...
  /// </remarks>
  // ================================================================================================
  public sealed class SimpleNameNodeToExpressionResultResolver : SyntaxNodeResolver<ExpressionResult, SimpleNameNode>
  {
    // ----------------------------------------------------------------------------------------------
    /// <summary>
    /// Initializes a new instance of the <see cref="SimpleNameNodeToExpressionResultResolver"/> class.
    /// </summary>
    /// <param name="syntaxNode">The syntax node to be resolved.</param>
    // ----------------------------------------------------------------------------------------------
    public SimpleNameNodeToExpressionResultResolver(SimpleNameNode syntaxNode)
      : base(syntaxNode)
    {
    }
    ...
    protected override ExpressionResult GetResolvedEntity(ISemanticEntity context, ICompilationErrorHandler errorHandler)
    {
      ...
      try
      {
        namespaceOrTypeEntity = NamespaceOrTypeNameNodeResolver<NamespaceOrTypeEntity>.ResolveSingleTypeTagInNamespaces(typeTagNode, context, context, typeArguments, errorHandler);
      }
