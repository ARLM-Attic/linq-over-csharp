...
namespace CSharpTreeBuilderTest
{
  ...
  public class ClassDeclarations: ParserTestBed
  {
    ...
    public void ClassDeclarationIsOk()
    {
      ...
      classDecl.BaseTypes[0].TypeName.TypeTags.Count.ShouldEqual(1);
      classDecl.BaseTypes[0].TypeName.TypeTags[0].Identifier.ShouldEqual("A");
    ...
    public void GenericClassDeclarationIsOk()
    {
      ...
      baseDecl.TypeName.TypeTags.Count.ShouldEqual(1);
      var tag = baseDecl.TypeName.TypeTags[0];
      tag.ShouldNotBeNull();
      tag.Identifier.ShouldEqual("List");
      tag.Arguments.Count.ShouldEqual(1);
      tag.Arguments[0].TypeName.TypeTags.Count.ShouldEqual(1);
      tag.Arguments[0].TypeName.TypeTags[0].Identifier.ShouldEqual("string");
      tag.Arguments[0].TypeName.TypeTags[0].HasTypeArguments.ShouldBeFalse();
      baseDecl = classDecl.BaseTypes[1];
      baseDecl.ShouldNotBeNull();
      baseDecl.TypeName.TypeTags.Count.ShouldEqual(1);
      tag = baseDecl.TypeName.TypeTags[0];
      tag.ShouldNotBeNull();
      ...
      tag.Arguments[0].TypeName.TypeTags.Count.ShouldEqual(1);
      tag.Arguments[0].TypeName.TypeTags[0].Identifier.ShouldEqual("X");
      tag.Arguments[0].TypeName.TypeTags[0].HasTypeArguments.ShouldBeFalse();
      tag.Arguments[1].TypeName.TypeTags.Count.ShouldEqual(1);
      tag.Arguments[1].TypeName.TypeTags[0].Identifier.ShouldEqual("Y");
      tag.Arguments[1].TypeName.TypeTags[0].HasTypeArguments.ShouldBeFalse();
      ...
      cTag.Type.TypeName.TypeTags.Count.ShouldEqual(1);
      cTag.Type.TypeName.TypeTags[0].Identifier.ShouldEqual("IEnumerable");
      cTag.Type.TypeName.TypeTags[0].Arguments.Count.ShouldEqual(1);
      cTag.Type.TypeName.TypeTags[0].Arguments[0].TypeName.TypeTags.Count.ShouldEqual(1);
      cTag.Type.TypeName.TypeTags[0].Arguments[0].TypeName.TypeTags[0].Identifier.ShouldEqual("Y");
      ...
      baseDecl = classDecl.BaseTypes[0];
      baseDecl.ShouldNotBeNull();
      baseDecl.TypeName.TypeTags.Count.ShouldEqual(4);
      tag = baseDecl.TypeName.TypeTags[0];
      tag.ShouldNotBeNull();
      tag.Identifier.ShouldEqual("System");
      tag.HasTypeArguments.ShouldBeFalse();
      tag = baseDecl.TypeName.TypeTags[1];
      tag.ShouldNotBeNull();
      tag.Identifier.ShouldEqual("Collections");
      tag.HasTypeArguments.ShouldBeFalse();
      tag = baseDecl.TypeName.TypeTags[2];
      tag.ShouldNotBeNull();
      tag.Identifier.ShouldEqual("Generic");
      tag.HasTypeArguments.ShouldBeFalse();
      tag = baseDecl.TypeName.TypeTags[3];
      tag.ShouldNotBeNull();
      tag.Identifier.ShouldEqual("List");
      tag.Arguments.Count.ShouldEqual(1);
      tag.Arguments[0].TypeName.TypeTags.Count.ShouldEqual(1);
      tag.Arguments[0].TypeName.TypeTags[0].Identifier.ShouldEqual("Z");
      tag.Arguments[0].TypeName.TypeTags[0].HasTypeArguments.ShouldBeFalse();
      ...
      cTag.IsTypeName.ShouldBeTrue();
      cTag.Type.TypeName.TypeTags.Count.ShouldEqual(1);
      cTag.Type.TypeName.TypeTags[0].Identifier.ShouldEqual("Hashtable");
      cTag.Type.TypeName.TypeTags[0].HasTypeArguments.ShouldBeFalse();
      cTag = constraint.ConstraintTags[1];
      cTag.IsTypeName.ShouldBeTrue();
      cTag.Type.TypeName.TypeTags.Count.ShouldEqual(1);
      cTag.Type.TypeName.TypeTags[0].Identifier.ShouldEqual("Dictionary");
      cTag.Type.TypeName.TypeTags[0].Arguments.Count.ShouldEqual(2);
      tag = cTag.Type.TypeName.TypeTags[0].Arguments[0].TypeName.TypeTags[0];
      tag.Identifier.ShouldEqual("string");
      tag.HasTypeArguments.ShouldBeFalse();
      tag = cTag.Type.TypeName.TypeTags[0].Arguments[1].TypeName.TypeTags[0];
      tag.Identifier.ShouldEqual("IEnumerable");
      tag.Arguments.Count.ShouldEqual(1);
      tag.Arguments[0].TypeName.TypeTags.Count.ShouldEqual(1);
      tag.Arguments[0].TypeName.TypeTags[0].Identifier.ShouldEqual("string");
