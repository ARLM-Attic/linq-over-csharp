...
using CompilationUnit=CSharpFactory.ProjectModel.CompilationUnit;
...
namespace CSharpFactory.CodeExplorer.TreeNodes
{
    ...
    IPropertyPanelSupport
  {
    ...
    private readonly ProjectModel.Namespace _Namespace;
    ...
    /// </summary>
    // ----------------------------------------------------------------------------------
    public ProjectModel.Namespace Namespace
    {
