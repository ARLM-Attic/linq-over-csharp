...
using ClassDeclaration=CSharpFactory.ProjectModel.ClassDeclaration;
using DelegateDeclaration=CSharpFactory.ProjectModel.DelegateDeclaration;
using EnumDeclaration=CSharpFactory.ProjectModel.EnumDeclaration;
using InterfaceDeclaration=CSharpFactory.ProjectModel.InterfaceDeclaration;
using StructDeclaration=CSharpFactory.ProjectModel.StructDeclaration;
...
namespace CSharpFactory.CodeExplorer.TreeNodes
{
  ...
  {
    private readonly ProjectModel.TypeDeclaration _TypeDeclaration;
    ...
    /// </summary>
    // ----------------------------------------------------------------------------------
    public ProjectModel.TypeDeclaration TypeDeclaration
    {
    ...
    // ----------------------------------------------------------------------------------
    protected TypeTreeNode(ProjectModel.TypeDeclaration type)
    ...
    // ----------------------------------------------------------------------------------
    public static TypeTreeNode CreateTypeNode(ProjectModel.TypeDeclaration type)
    {
