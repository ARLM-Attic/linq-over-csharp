...
namespace CSharpParser.ProjectModel
{
  ...
  public sealed class DivideAssignmentOperator : AssignmentOperator
  {
    ...
    // --------------------------------------------------------------------------------
    public DivideAssignmentOperator(Token token, CSharpSyntaxParser parser) : base(token, parser)
    {
    }
    ...
    // --------------------------------------------------------------------------------
    public DivideAssignmentOperator(Token token, Expression leftOperand) : 
